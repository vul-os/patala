...
|---|---|---|
| HotSpot signal handlers replaced ([`sdks/java/signal-probe.sh`](../sdks/java/signal-probe.sh), OpenJDK 26.0.2) | **0**, and 0 with altered flags | 5 replaced, 3 with altered flags |
