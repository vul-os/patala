...
[`sdks/`](../sdks/README.md) — [Fifteen language packages](language-packages.md)
...
generated, built and run: [`sdks/kotlin`](../sdks/kotlin/README.md) *is* the
generated Kotlin, and [`sdks/swift/uniffi`](../sdks/swift/uniffi/) sits
