<!-- Generated from docs/compensating-payments.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/compensating-payments.md and regenerate. `--check` fails the build if these drift. -->
...
[`site/docs/status.md`](status.md#destination-validation-by-rail).
...
- [`PATALA.md`](https://github.com/vul-os/patala/blob/main/PATALA.md) §3 — the seam.
- [`site/docs/status.md`](status.md) — what is tested, and what is
