<!-- Generated from docs/polyglot.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/polyglot.md and regenerate. `--check` fails the build if these drift. -->
