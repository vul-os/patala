<!-- Generated from docs/quickstart.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/quickstart.md and regenerate. `--check` fails the build if these drift. -->
# Quickstart
...
[`sdks/README.md`](https://github.com/vul-os/patala/blob/main/sdks/README.md) is the index that ships with the code.
