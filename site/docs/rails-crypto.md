<!-- Generated from docs/rails-crypto.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/rails-crypto.md and regenerate. `--check` fails the build if these drift. -->
