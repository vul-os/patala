<!-- Generated from docs/rails-fiat.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/rails-fiat.md and regenerate. `--check` fails the build if these drift. -->
