<!-- Generated from docs/self-host-vendor.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/self-host-vendor.md and regenerate. `--check` fails the build if these drift. -->
# Self-host & vendor
