<!-- Generated from docs/shared-economics.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/shared-economics.md and regenerate. `--check` fails the build if these drift. -->
