<!-- Generated from docs/sidecar.md by `node scripts/gen-site-docs.mjs`. Do not edit this file;
     edit docs/sidecar.md and regenerate. `--check` fails the build if these drift. -->
